...
export async function generateMetadata(props: PageProps<"/[locale]/p/[slug]">): Promise<Metadata> {
...
export default async function CmsPage(props: PageProps<"/[locale]/p/[slug]">) {
